...
const questoesSelecionadas = questoesAleatorias.slice(0, 10);



let totalAcertos = 0;

questoesSelecionadas.forEach((questao, indice) => {
  const pergunta = (`${indice + 1} - ${questao.pergunta}`);
  console.log(pergunta);

  const resposta = entradaDados.question("Digite a resposta (ano): ");
...
console.log(`Acertos: ${totalAcertos}/10`);
resultadoFinal(totalAcertos);
